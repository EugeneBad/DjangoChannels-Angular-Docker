resource "google_compute_instance_template" "k8sclstr-template" {
  ...
  metadata_startup_script = "sudo kubeadm join 10.0.0.2:6443 --token 81ylqd.rcjxmfjgnf6rfuxx --discovery-token-ca-cert-hash sha256:e539b3738e93bc09f5a86b90568c71580adc8148e97efead8cc732f416c46bca"
